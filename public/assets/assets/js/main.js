...
(function ($) {
    ...
    Wolmart.initPopup = function (options, preset) {
        ...
        // Newsletter popup
        if (Wolmart.$body.hasClass('home-as') && Wolmart.getCookie('hideNewsletterPopup') !== 'true') {
            setTimeout(function () {
                Wolmart.popup({
                    items: {
                        src: 'file:///E:/all%20theme/wolmart/wolmart_v1.0(client)/assets/ajax/newsletter.html'
                    },
                    type: 'ajax',
                    tLoading: '',
