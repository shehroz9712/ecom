    ...
    <div class="product text-center">
        <figure class="product-media">
            ...
            <a href="{{ route('user.product.detail', $product->slug) }}">
                @if ($product->images->count() >= 2)
                    <img src="{{ productImage($product->images[0]->image) }}" alt="{{ $product->name }}" width="300" height="338" />
                    <img src="{{ productImage($product->images[1]->image) }}" alt="{{ $product->name }}" width="300" height="338" />
                @else
        ...
        <div class="product-details">
            ...
            <div class="ratings-container">
                ...
                <a href="{{ route('user.product.detail', $product->slug) }}#reviews" class="rating-reviews">({{ $product->reviews_count }} reviews)</a>
            </div>
