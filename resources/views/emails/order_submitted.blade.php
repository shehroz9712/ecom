...
<body>
    ...
    {{-- Coupon code on next order --}}
    @if ($coupon)
        <p>This is your promo code <strong>{{ $coupon->code }}</strong>, please complete your order before <strong>{{ \Carbon\Carbon::parse($coupon->expiry_date)->format('F j, Y') }}</strong>. You can use this promo code for 5% OFF.</p>
    @endif
</body>
</html>
