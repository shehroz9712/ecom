...
<body>
    ...
    <p>Here's your confirmation for Order Number {{ $order_number }}. Review your receipt and get started using your products.</p>
    ...
    <table border="0" width="100%" cellpadding="10" cellspacing="0" style="font-family:arial;">
        <tr >
            ...
            <th style="border-top:1px solid #999;border-right:1px solid #999;" align="left">Purchased Template</th>
        ...
        <tr>
            ...
            <td style="border-right:1px solid #999;">{{ $template['name'] }}</td>
            <td style="border-right:1px solid #999;" align="right">{{ $currency }} {{ $template['price'] }}</td>
        </tr>
        ...
        <tr>
            <td style="font-weight:bold;border-left:1px solid #999;" align="right" colspan="2" >Tax ({{ $tax_rate }}%):</td>
