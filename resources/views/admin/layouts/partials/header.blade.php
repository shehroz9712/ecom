        ...
        <div class="main-navbar">
            <div id="mainnav">
                <ul class="nav-menu custom-scrollbar">
                    ...
                    <li class="dropdown">
                        <a class="nav-link menu-title {{ request()->routeIs('admin.admins.*') ? 'active' : '' }}"
                    ...
                    <li class="dropdown">
                        <a class="nav-link menu-title {{ request()->routeIs('admin.users.*') ? 'active' : '' }}"
                    ...
                    <li class="dropdown">
                        <a class="nav-link menu-title {{ request()->routeIs('admin.orders.*') ? 'active' : '' }}"
                    ...
                    <li><a href="{{ route('admin.review_images.index') }}"><i data-feather="image"></i><span>Review
                                Images</span></a></li>
                    <li><a href="{{ route('admin.testimonials.index') }}"><i
                                data-feather="message-circle"></i><span>Testimonials</span></a></li>
                    <li><a href="{{ route('admin.vendors.index') }}"><i
                                data-feather="briefcase"></i><span>Vendors</span></a></li>
                    <li><a href="{{ route('admin.wishlists.index') }}"><i
                    ...
                    <li><a href="{{ route('admin.payment_methods.index') }}"><i
